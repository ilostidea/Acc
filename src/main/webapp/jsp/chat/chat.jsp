...
<script type="text/javascript">
	...
	function connect() {
		...
		if ('WebSocket' in window) {
			ws = new WebSocket("ws://127.0.0.1:8080/websck");
			console.log("ws://127.0.0.1:8080/websck");
		} else {
			ws = new SockJS("http://127.0.0.1:8080/websck/sockjs");
			console.log("http://127.0.0.1:8080/websck/sockjs");
		}
		ws.onopen = function() {
			alert('open');
			setConnected(true);
...
<body>
	<noscript>
	    ...
	    rely on Javascript being enabled. Please enable Javascript and reload this page!
	    </h2>
	</noscript>
