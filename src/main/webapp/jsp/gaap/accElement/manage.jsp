...
<body>
      ...
      <div class="row row-offcanvas row-offcanvas-left" >
        ...
        <div class="col-xs-6 col-sm-2 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            ...
            <a href="#" class="list-group-item">具体准则</a>
            <a href="../financialReport/manage.jsp" class="list-group-item">财务报表</a>
            <a href="#" class="list-group-item active">科目分类</a>
	...
	function toadd(){
    	...
    	window.location.href = "/jsp/gaap/accElement/add.jsp?accStandardID=" + accStandardID;
	}
    ...
    function edit(id){
		var accStandardID = $("#standard").val();
    	window.location.href = "/jsp/gaap/accElement/add.jsp?id=" + id + "&accStandardID=" + accStandardID;
    }
	
	function getSP(){
		var accStandardID = $("#standard").val();
		$.get("/accElement/queryBy",
      		  ...
      		  function(responseTxt, status){
      			if(status == "success"){
    				...
    				for(var i = 0; i < len; i++){
    					...
    					var td2 = $("<td></td>").text(datas[i].status?"启用":"禁用");
