...
<body>
  ...
  <body>
      ...
      <div class="row row-offcanvas row-offcanvas-left" >
        ...
        <div class="col-xs-6 col-sm-2 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            ...
            <a href="#" class="list-group-item active">具体准则</a>
	...
	function toadd(){
    	...
    	window.location.href = "/jsp/gaap/specificStandard/add.jsp?accStandardID=" + accStandardID;
	}
    ...
    function edit(id){
		var accStandardID = $("#standard").val();
    	window.location.href = "/jsp/gaap/specificStandard/add.jsp?id=" + id + "&accStandardID=" + accStandardID;
    }
