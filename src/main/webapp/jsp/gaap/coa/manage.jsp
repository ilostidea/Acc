...
<body>
  ...
  <body>
      ...
      <div class="row row-offcanvas row-offcanvas-left" >
        ...
        <div class="col-xs-6 col-sm-2 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
            ...
            <a href="#" class="list-group-item active">会计科目</a>
	...
	function toadd(){
    	...
    	window.location.href = "/jsp/gaap/coa/add.jsp?accStandardID=" + accStandardID;
	}
    ...
    function edit(id){
		var accStandardID = $("#standard").val();
    	window.location.href = "/jsp/gaap/coa/add.jsp?id=" + id + "&accStandardID=" + accStandardID;
    }
      		  ...
      		  function(responseTxt, status){
      			if(status == "success"){
    				...
    				for(var i = 0; i < len; i++){
    					...
    					var td0 = $("<td></td>").text(datas[i].elementCode);
    					var td1 = $("<td></td>").text(datas[i].code);
    					var td2 = $("<td></td>").text(datas[i].name);
    					var td3 = $("<td></td>").text(datas[i].status?"启用":"禁用");
    					var td4 = $("<td></td>").html("<a href=\"javascript:rm(" + datas[i].id + ", 'tr" + i + "');\" class=\"text-danger\"><i class=\"far fa-trash-alt fa-xs \" aria-hidden=\"true\"></i></a>" +
    					                                             "&nbsp;&nbsp;" + 
