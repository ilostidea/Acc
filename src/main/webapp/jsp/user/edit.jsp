        ...
        <div class="col-xs-12 col-sm-10 pull-right">
          ...
          <div class="row">
            <div class="col-xs-6 col-lg-12">
             <!-- 右侧内容区 -->
				<c:url var="saveUrl" value="/user/save/${sysUser.id }" />
			    <form:form modelAttribute="sysUser" action="${saveUrl}" method="post">
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
							...
							<label class="col-sm-2 control-label" for="email">状态</label>
							<div class="col-sm-4">
								<input type="hidden" id="_status"  value="${sysUser.status }"/>
							    <form:select path="status" id="status" class="form-control">
							    	<option value="false">禁用</option>
							    	<option value="true">启用</option>
							    </form:select>
							    <font color="red"><form:errors path="status"></form:errors></font>
							</div>
				    </div>
					<div class="form-group">
